...
class Bill_App:
    ...
    # ===================Medical====================================
        ...
        cream_lbl = Label(F2, text="Cold cream", font=('times new roman', 16, 'bold'), bg = "#badc57", fg = "black")
    ...
    # ==========GroceryItems=========================
        ...
        maggi_lbl = Label(F3, text="Noodles", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
    ...
    # ===========ColdDrinks================================
        ...
        sprite_lbl = Label(F4, text="Pepsi", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
        ...
        mineral_lbl = Label(F4, text="Cococola", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
        ...
        lassi_lbl = Label(F4, text="Lichhi", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
